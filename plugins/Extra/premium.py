...
async def plan(client, message):
    ...
    await message.reply_photo(photo="https://envs.sh/aPl.jpg", caption=script.PREPLANS_TXT.format(message.from_user.mention), reply_markup=InlineKeyboardMarkup(btn))
